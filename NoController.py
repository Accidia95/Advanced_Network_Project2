...
def MyNet():  
    ...
    #s10  
    s10.cmd(r'ovs-ofctl add-flow s10 "arp,nw_dst=10.0.0.0/24,actions=output:1"')  
    s10.cmd(r'ovs-ofctl add-flow s10 "arp,nw_dst=10.0.1.0/24,actions=output:2"')  
    s10.cmd(r'ovs-ofctl add-flow s10 "icmp,nw_dst=10.0.0.0/24,actions=output:1"')  
    s10.cmd(r'ovs-ofctl add-flow s10 "icmp,nw_dst=10.0.1.0/24,actions=output:2"')  
    ...
    #s11
    s11.cmd(r'ovs-ofctl add-flow s11 "arp,nw_dst=10.1.0.0/24,actions=output:1"')  
    s11.cmd(r'ovs-ofctl add-flow s11 "arp,nw_dst=10.1.1.0/24,actions=output:2"')  
    s11.cmd(r'ovs-ofctl add-flow s11 "icmp,nw_dst=10.1.0.0/24,actions=output:1"')  
    s11.cmd(r'ovs-ofctl add-flow s11 "icmp,nw_dst=10.1.1.0/24,actions=output:2"')  
    ...
    #s12  
    s12.cmd(r'ovs-ofctl add-flow s12 "arp,nw_dst=10.1.0.0/24,actions=output:1"')  
    s12.cmd(r'ovs-ofctl add-flow s12 "arp,nw_dst=10.1.1.0/24,actions=output:2"')  
    s12.cmd(r'ovs-ofctl add-flow s12 "icmp,nw_dst=10.1.0.0/24,actions=output:1"')  
    s12.cmd(r'ovs-ofctl add-flow s12 "icmp,nw_dst=10.1.1.0/24,actions=output:2"')  
    ...
    #s13  
    s13.cmd(r'ovs-ofctl add-flow s13 "arp,nw_dst=10.2.0.0/24,actions=output:1"')  
    s13.cmd(r'ovs-ofctl add-flow s13 "arp,nw_dst=10.2.1.0/24,actions=output:2"')  
    s13.cmd(r'ovs-ofctl add-flow s13 "icmp,nw_dst=10.2.0.0/24,actions=output:1"')  
    s13.cmd(r'ovs-ofctl add-flow s13 "icmp,nw_dst=10.2.1.0/24,actions=output:2"')  
    ...
    #s14
    s14.cmd(r'ovs-ofctl add-flow s14 "arp,nw_dst=10.2.0.0/24,actions=output:1"')  
    s14.cmd(r'ovs-ofctl add-flow s14 "arp,nw_dst=10.2.1.0/24,actions=output:2"')  
    s14.cmd(r'ovs-ofctl add-flow s14 "icmp,nw_dst=10.2.0.0/24,actions=output:1"')  
    s14.cmd(r'ovs-ofctl add-flow s14 "icmp,nw_dst=10.2.1.0/24,actions=output:2"')  
